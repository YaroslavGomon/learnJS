...
// console.log(new Date(1 * 24 * 60 * 60 * 1000)); // time stamp
...
console.log(futureDate.getDay()); // нумерация дней начинается с нуля и воскресенья
...
console.log(futureDate.getTime()); // кол во миллисекунд с юникс тайма 1970
console.log(new Date(7956084539000));
console.log(Date.now()); // тайм стамп для текущего времени

futureDate.setFullYear(3333);
console.log(futureDate);
