...
//   gameEvents = [...gameEvents, event];
// } // extract events from Map

// gameEvents = new Set(gameEvents); // create Set to delete duplicates
// gameEvents = [...gameEvents]; // spread method to create array with no duplicates
...
// }
// console.log(
//   `On average, an event happened every ${(sum / 90).toFixed(1)} minutes.`
// );
